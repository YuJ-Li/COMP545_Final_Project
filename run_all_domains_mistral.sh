...
# Mistral Large 2 Evaluation - All 16 Domains
# Author: Kazi
# Date: Nov 2024

echo "================================================================================"
echo "               Mistral Large 2 Evaluation - All 16 Domains"
echo "================================================================================"
echo ""
echo "This will:"
echo "  • Load 10 tasks per domain (160 total)"
echo "  • Run Mistral Large 2 with AND without context"
echo "  • Total runtime: ~6-8 hours"
echo "  • Total cost: ~\$8-10 on Lambda/RunPod"
echo ""
...
for domain in "${domains[@]}"; do
    ...
    python3 run_mistral_standalone.py --domain "$domain" --use-context
...
for domain in "${domains[@]}"; do
    ...
    python3 run_mistral_standalone.py --domain "$domain" --no-context
...
echo ""
echo "Results saved to: Results/<domain>/mistral_{with/no}_context_results.csv"
echo ""
echo "Next steps:"
echo "  1. Download results back to your Mac"
echo "  2. Compare Mistral vs GPT-4o Mini vs Llama 3.2-3B"
echo "  3. Train XGBoost selector!"
echo ""
echo "================================================================================"